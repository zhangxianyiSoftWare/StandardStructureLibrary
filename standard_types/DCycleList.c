...
*
*****************************************************************************/
static bool cycle_list_del( pCycleList plist, pCycleListNode del_node )
{
...
/*****************************************************************************
*   Prototype    : cycle_list_delByid
*   Description  : delete a list node by node id
*   Input        : pCycleList plist
*                  uint32 del_node_id
*   Output       : None
*   Return Value : bool
...
*
*****************************************************************************/
bool cycle_list_delById( pCycleList plist, uint32 del_node_id )
{
    pCycleListNode temp = getCycleListNode(plist, del_node_id);
    return cycle_list_del(plist, temp);
}

/*****************************************************************************
*   Prototype    : getCycleListNode
*   Description  : get a cycle list node from cycle plist
*   Input        : pCycleList plist
*                  uint32 nid
*   Output       : None
...
*
*****************************************************************************/
pCycleListNode getCycleListNode( pCycleList plist, uint32 nid )
{
    //temp pointer 
    pCycleListNode node= plist->phead->pnext;
    //if search a node but the list end
    while( TRUE != equal2CycleListNode(node, plist->ptail) )
    {
        //search a same node
