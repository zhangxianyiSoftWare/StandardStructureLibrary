...
extern bool fix_array_add(pFixArray pCArray,const void* resource, uint32 i_elem_size );
extern pFixArray fix_array_create(uint32 length,uint32 elem_size,bool (* freefunc)(void * elem)  );
extern bool fix_array_destory( pFixArray pCarray );
extern bool fix_array_empty( pFixArray pCarray );
extern bool fix_array_full( pFixArray pCarray );
